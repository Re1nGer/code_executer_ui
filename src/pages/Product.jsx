    ...
    return (
        <div className={`flex justify-center min-h-[320px] gap-[50px]`}>
            ...
            <div className={'flex-1 max-h-[700px] product__banner_container'}>
                <div className={'flex flex-wrap gap-[10px] text-white font-bold max-h-[500px] max-w-[600px] product__banner'}>
                    <ProductPromptSkeletons/>
                    <ProductTestSkeletons />
                    <div className={"bg-[#15314b] max-h-[205px] flex flex-col rounded-[4px] border-[2px] border-[#15314b] max-w-[291px] h-full w-full"}>
                        ...
                        <div className={'flex flex-col gap-[10px] bg-[#02203c] product__test_scrollbar'}>
                            <div className={'rounded-[4px] flex gap-[4px] items-center h-[50px]  mt-[10px] p-[10px] shadow-[0_2px_4px_rgba(50,50,93,.1)] bg-[#15314b]'}>
                                <div className={"bg-[#48aca2] w-[21px] rounded-[4px] h-[13px]"}></div>
                                <div className={"bg-[#48aca2] w-[21px] rounded-[4px] h-[13px]"}></div>
                                <div className={"bg-[#48aca2] w-[21px] rounded-[4px] h-[13px]"}></div>
                                <div className={"bg-[#48aca2] w-[21px] rounded-[4px] h-[13px]"}></div>
                            </div>
                            <div className={'rounded-[4px] flex items-center gap-[4px] h-[50px] p-[10px] shadow-[0_2px_4px_rgba(50,50,93,.1)] bg-[#15314b]'}>
                                <div className={"bg-[#48aca2] w-[21px] rounded-[4px] h-[13px]"}></div>
                                <div className={"bg-[#48aca2] w-[21px] rounded-[4px] h-[13px]"}></div>
                                <div className={"bg-[#48aca2] w-[21px] rounded-[4px] h-[13px]"}></div>
                                <div className={"bg-[#48aca2] w-[21px] rounded-[4px] h-[13px]"}></div>
